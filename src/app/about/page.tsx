      ...
      <div className="min-h-screen py-20 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="w-16 h-0.5 bg-dustyRose/30 mx-auto" role="presentation" aria-hidden="true" />
          </motion.header>
          ...
          >
            <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-dustyRose/20 mb-6 relative">
              <Image
                ...
                alt="Likhon Sheikh - Profile Picture"
                fill
            ...
            <h2 id="profile-heading" className="font-heading text-2xl font-medium text-charcoal mb-2">
              Likhon Sheikh
            </h2>
            <p className="text-charcoal/60 text-sm max-w-md text-center">
          ...
          <motion.article
            ...
            className="prose prose-lg prose-p:text-charcoal/80 prose-headings:font-heading prose-headings:text-charcoal"
          >
            ...
            {/* Quote */}
            <blockquote className="border-l-4 border-dustyRose/40 pl-6 my-8 italic text-charcoal/70">
              "Code is poetry written in logic, and AI is the verse that learns to write itself."
            </blockquote>

            {/* Expertise Tags */}
            <div className="flex flex-wrap gap-3 justify-center mb-8" role="list" aria-label="Technical skills">
              {['React', 'Next.js', 'Solidity', 'Node.js', 'AI Agents', 'Smart Contracts'].map((skill) => (
                <span
                  key={skill}
                  role="listitem"
                  className="px-4 py-2 bg-dustyRose/15 text-dustyRose/90 rounded-full text-sm font-medium"
                >
                  {skill}
                </span>
              ))}
            ...
            {/* Contact */}
            <section className="bg-softGray/40 rounded-xl p-6 mt-8" aria-labelledby="contact-heading">
              <h3 id="contact-heading" className="font-heading text-lg font-medium text-charcoal mb-3">
                Get in Touch
              </h3>
